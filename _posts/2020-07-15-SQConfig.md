...
![Change Admin Password]({{ site.baseurl }}/images/posts/sq/chgpwd.JPG)

Change Password

![New Admin Password]({{ site.baseurl }}/images/posts/sq/newadminpwd.JPG)

#### Force authentication

![Force authentication]({{ site.baseurl }}/images/posts/sq/forcesecurity.jpg)
...
![Add user]({{ site.baseurl }}/images/posts/sq/serverbaseurl.jpg)

### Create Project

SonarQube provides 2 ways to create a project.

![CreateProject]({{ site.baseurl }}/images/posts/sq/crtprj.JPG)

Provide Project Key (without space) and Display Name. 

![Create Project Setup]({{ site.baseurl }}/images/posts/sq/prjsetup.JPG)

> **This key will require when you will configure the Sonarqube with Azure Pipelines.**

![Create Project Setup]({{ site.baseurl }}/images/posts/sq/project.jpg)
...
![Token]({{ site.baseurl }}/images/posts/sq/demotoken.jpg)


You can have 1 token across the projects or you can have individual tokens. 

![Token1]({{ site.baseurl }}/images/posts/sq/token1.jpg)


![Token2]({{ site.baseurl }}/images/posts/sq/token2.jpg)
...
![Add user]({{ site.baseurl }}/images/posts/sq/crtuser1.jpg)

![Add user]({{ site.baseurl }}/images/posts/sq/crtuser2.jpg)

![Add user]({{ site.baseurl }}/images/posts/sq/crtuser3.jpg)

#### Add User to project

![Add user to project]({{ site.baseurl }}/images/posts/sq/adduser1.jpg)

Add user to project with desired permissions by selecting the checkbox.

![Add user to project]({{ site.baseurl }}/images/posts/sq/adduser2.jpg)

Let's assign this user *Execute Analysis Permission* and see the difference.

![Add user to project]({{ site.baseurl }}/images/posts/sq/adduser4.jpg)
